...
pretrained_model="sky_workdir/lora-scripts/sd-models/v1-5-pruned.safetensors" # base model path | 底模路径
train_data_dir="sky_workdir/lora-scripts/input/lrao"              # train dataset path | 训练数据集路径
