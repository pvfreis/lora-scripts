...
$network_alpha = 128 # network alpha , usually the same value as network_dim or a smaller value, such as half of network_dim to prevent underflow. Default value is 1, using a smaller alpha requires increasing the learning rate.
